...
import { Notebook, CheckSquare, Upload, BarChart2 } from 'lucide-react'
...
function HowItWorksSection() {
  ...
  const steps = [
    ...
    {
      icon: CheckSquare,
      title: 'Get a Custom Test',
      description: "Our AI analyzes your notes and generates a quiz with questions tailored to the topics you've studied.",
    },
    {
      icon: BarChart2,
      title: 'Track Your Progress',
      description: 'Take the quiz, see where you stand, and get personalized feedback on your strengths and areas for improvement.',
    },
  ]
...
function TestimonialsSection() {
  ...
  const testimonials = [
    { name: 'Sarah', role: 'College Student', quote: 'QuizNote helped me nail down weak areas right before finals!' },
    { name: 'Mike', role: 'High School Teacher', quote: 'An excellent tool for creating custom quizzes for my students.' },
    { name: 'Emily', role: 'Medical Resident', quote: 'QuizNote made studying for board exams much more efficient.' },
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <p className="text-lg mb-4 text-indigo-200">"{testimonial.quote}"</p>
...
//           <p className="text-sm text-indigo-400">&copy; 2023 QuizNote. All rights reserved.</p>
//         </div>
//       </div>
//     </footer>
//   )
